        ...
        <div className="bg-white shadow-md rounded-lg p-8 w-full max-w-md">
          ...
          <div className="flex gap-3 mb-4">
            <button
              type="button"
              onClick={() => googleLogin()}
              className="flex-1 bg-white border border-gray-300 text-gray-700 font-semibold py-2 px-4 rounded-full hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all flex items-center justify-center gap-2 cursor-pointer"
            >
            ...
            <button
              type="button"
              onClick={() => githubLogin()}
              className="flex-1 bg-gray-800 text-white font-semibold py-2 px-4 rounded-full hover:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-gray-600 transition-all flex items-center justify-center gap-2 cursor-pointer"
            >
