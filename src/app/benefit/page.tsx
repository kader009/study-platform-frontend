      ...
      <main className="min-h-screen flex flex-col lg:flex-row">
        <div className="lg:w-5/12 relative h-100 lg:h-auto overflow-hidden">
          ...
          <img
            ...
            data-alt="Students collaborating in a modern bright educational setting"
            ...
            <div className="flex items-center gap-4 mb-4">
              <div className="flex -space-x-3">
                ...
                <img
                  alt="User"
                  className="w-10 h-10 rounded-full border-2 border-white"
                  data-alt="Male student portrait"
                ...
                <img
                  alt="User"
                  className="w-10 h-10 rounded-full border-2 border-white"
                  data-alt="Professional mentor portrait"
            ...
            <div className="mt-16 pt-8 border-t border-slate-100 dark:border-slate-800">
              ...
              <div className="flex flex-wrap gap-8 grayscale opacity-50 dark:invert">
                <div className="flex items-center gap-2">
                  <span className="material-icons text-xl">blur_on</span>
                  <span className="font-bold text-lg italic">TECHCORP</span>
                </div>
                <div className="flex items-center gap-2">
                  <span className="material-icons text-xl">grain</span>
