    ...
    <>
      {!isOpen && (
        <button
          ...
          className="fixed bottom-4 right-4 md:bottom-6 md:right-6 bg-gradient-to-r from-blue-600 to-gray-400 text-white p-3 md:p-4 rounded-full shadow-lg hover:shadow-xl transition-all z-50"
